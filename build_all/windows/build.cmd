...
if "%1" equ "--use-zc-preprocessor" goto arg-zc-preprocessor
call :usage && exit /b 1
...
echo  --use-zc-preprocessor         Enable MSVC /Zc:preprocessor conformant preprocessor
goto :eof
